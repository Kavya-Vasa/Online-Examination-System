<?php
    ...
    $insert= "INSERT INTO addquestions_tbl(course_name, question_number, question, option_1, option_2, option_3, option_4, correct_option)
    ...
    if($insert_query) {
        ?>
          <script>
               alert('Data inserted');
               location.replace('./addQuestions.php');
          </script>
        <?php    
    } else {
        ?>
